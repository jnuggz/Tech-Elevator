<template>
  <div class="main">
    ...
    <div class="well-display">
      ...
      <div class="well">
        <span class="amount" v-on:click="filterValue = 1">{{ numberOfOneStarReviews }}</span>
        1 Star Review{{ numberOfOneStarReviews === 1 ? "" : "s" }}
      </div>

      <div class="well">
        <span class="amount" v-on:click="filterValue = 2">{{ numberOfTwoStarReviews }}</span>
        2 Star Review{{ numberOfTwoStarReviews === 1 ? "" : "s" }}
      </div>

      <div class="well">
        <span class="amount" v-on:click="filterValue = 3">{{ numberOfThreeStarReviews }}</span>
        3 Star Review{{ numberOfThreeStarReviews === 1 ? "" : "s" }}
      </div>

      <div class="well">
        <span class="amount" v-on:click="filterValue = 4">{{ numberOfFourStarReviews }}</span>
        4 Star Review{{ numberOfFourStarReviews === 1 ? "" : "s" }}
      </div>

      <div class="well">
        <span class="amount" v-on:click="filterValue = 5">{{ numberOfFiveStarReviews }}</span>
  ...
  computed: {
    ...
    filteredReviews(){
      return this.reviews.filter(review => {
        return this.filterValue === 0 ? true : this.filterValue === review.rating
      })
    },
    isFormValid(){
      return this.newReview.reviewer && this.newReview.title && this.newReview.rating
