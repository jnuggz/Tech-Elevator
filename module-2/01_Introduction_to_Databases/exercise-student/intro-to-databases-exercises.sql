...
-- 1) Figure out what table you are working with for the FROM
-- 2) Figure out how to limit to the correct rows using the WHERE
-- 3) Limit to the ONLY the columns expected using the SELECT <col>
...
SELECT (2021 - indepyear) AS years_since_independence FROM country WHERE indepyear IS NOT NULL