...
-- 3. Extra practice with Delete
SELECT * FROM country;
SELECT * FROM country WHERE code = 'USA';
DELETE FROM country WHERE code = 'USA'; -- This will lead to a constraint error (Referential Integrity)
...
ROLLBACK; --Only works if START TRANSACTION
COMMIT; --Saves work only if START TRANSACTION
SELECT * FROM countrylanguage;
