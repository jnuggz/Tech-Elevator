...
public class Lecture {
	...
	public static void main(String[] args) {
		...
		/* DECLARING AN D INSTANTIATING A MAP */
		...
		// Line below will result in true
		boolean mooExists = animalNoises.containsValue("Moo");
		// line below will result in false, no Key exist
		...
		// Must use .getKey() and .getValue()
		for(Map.Entry<String, String> mapEntry : animalNoises.entrySet()) {
			System.out.println("The mapEntry " + mapEntry.getKey() + " says " + mapEntry.getValue());
		}
		...
		// Line will result in "1 is One" then "10 is Ten"
