...
public class Exercises {
	...
	public String animalGroupName(String animalName) {
		/*
		* Return name of the group (value) of that animal
		* Animal name should be case insensitive
		* If name of animal (key) is not found, null, or empty, return "unknown"
		* Return value, use .get()
		* */
		Map<String, String>	animalGroupName = new HashMap<String, String>() ;
			...
			for (String animal : animalGroupName.keySet()){
				if(animal.equalsIgnoreCase(animalName));
				return animalGroupName.get(animal);
			}
		return notFound;
	}
	...
	public double isItOnSale(String itemNumber) {
		/*
		 * Return discount percentage if item on sale, .containsKey()
		 * If item not for sale, return 0.00
		 * If item is empty or null, return 0.00
		 * Item should be case insensitive
		 */
	...
	public Map<String, Integer> robPeterToPayPaul(Map<String, Integer> peterPaul) {
		...
		// Determine if we should transfer money to Paul
	...
	public Map<String, Integer> peterPaulPartnership(Map<String, Integer> peterPaul) {
		...
		// If Peter has 50 >= AND Paul has 100 >= create new map
		if (peterMoney >= 5000 && paulMoney >= 10000){
			...
			int peterPaulPartnership = partnershipPeter + partnershipPaul;
