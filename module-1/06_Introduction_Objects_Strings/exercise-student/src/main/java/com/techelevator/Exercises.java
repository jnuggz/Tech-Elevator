...
public class Exercises {
	...
	public String withoutEnd(String str) {
		...
		return str.substring(1, firstLast -1 );
	}
	...
	public String middleTwo(String str) {
		int twoMiddle = str.length() / 2;
		return str.substring(twoMiddle-1, twoMiddle+1);
	}
	...
	public String altPairs(String str) {
		...
		// How to skip every other set of 2 so we got 01, 45, 89,...
		// How to put together the new String
		// How to handle odd length stringsInt
