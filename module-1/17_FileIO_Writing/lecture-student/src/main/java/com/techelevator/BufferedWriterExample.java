...
public class BufferedWriterExample {
    ...
    public static void main(String[] args) throws IOException {
        //adding throws to the main method will crash
        //could add IOException
        ...
        try (PrintWriter printWriter = new PrintWriter(file);
            ...
            //line above will cause IOException, see line 7 to add a throws IOException
            /*
            ...
            /*
                Unlike printWriter's println(), bufferedWriter's write() does not add
