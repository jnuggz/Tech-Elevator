...
public class Lecture {
    ...
    */
    public String returnFizzIfThreeUsingTernary(int number) {
        String fizzString = number == 3 ? "Fizz" : "";
    ...
    */
    ...
    public static void main(String[] args) {
        ...
        boolean shouldRunCode = false;
        int numX = 7;
        int numY = 0;

        if (numX % 7 == 0 && numX % 10 == 0) {
            System.out.println("the value was divisible by both");
        } else if ( numX % 7 == 0) {
            System.out.println("the value was divisible by 7");
        } else if (numX % 10 == 0) {
            System.out.println("the value was divisible by 10");
        } else {
            System.out.println("the value was not divisible by 7 or 10");
        }
