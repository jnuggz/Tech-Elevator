...
public class Exercises {
	...
	public String[] list2Array(List<String> stringList) {
		String[] sameArray = stringList.toArray(new String[stringList.size()]);
		return sameArray;
	}
...
//			for loop below gdo the same thing as for each loop
...
//			String word = stringArray[i];
	...
	public List<Double> arrayInt2ListDouble(int[] intArray) {
		...
		//Double used because of decimal places used
		List<Double> divideByTwo = new ArrayList<Double>();
		for (Integer half : intArray){
			divideByTwo.add(half / 2.0);
		}
		return divideByTwo;
	}
	...
	** INTERVIEW QUESTION **
	...
	public List<String> fizzBuzzList(Integer[] integerArray) {
		...
		for (Integer fizzList : integerArray){
	...
	public List<Integer> interleaveLists(List<Integer> listOne, List<Integer> listTwo) {
		...
		for (Integer interLeave : listOne){
			interWoven.add(0);
		}
		for (Integer interLeaveTwo : listTwo) {
